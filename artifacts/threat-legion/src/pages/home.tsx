...
import { Shield, Zap, Code, Search, ArrowRight, CheckCircle2, Loader2, Lock, Activity, Key, Users, LineChart } from "lucide-react";
        ...
        <div className="container relative z-20 mx-auto px-4 sm:px-6 lg:px-8 pb-24 border-t border-white/5 pt-24">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              Anthropic, OpenAI, DeepSeek, and Groq — you stay in control of your data and costs.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Plug in your Anthropic, OpenAI, DeepSeek, or Groq API key. Threat Legion translates the multi-agent protocol to whichever API you prefer.",
              },
              {
                icon: <Users className="w-6 h-6 text-primary" />,
                title: "Why not just use Claude directly?",
                desc: "You could — but you'd have to engineer the five-agent architecture, the file routing, the tool schemas, and the synthesis pass yourself. Threat Legion is that infrastructure, prebuilt and tuned for security analysis.",
              },
              {
                icon: <LineChart className="w-6 h-6 text-primary" />,
                title: "Cost-efficient at scale",
                desc: "Because you supply the key, there's no per-scan mark-up. Run hundreds of scans against your own rate limits and budget — no Threat Legion subscription needed.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <div className="container relative z-20 mx-auto px-4 sm:px-6 lg:px-8 pb-24">
          <div className="rounded-2xl border border-white/5 bg-card/30 p-8 text-center max-w-2xl mx-auto">
            ...
            <p className="text-sm text-muted-foreground max-w-lg mx-auto">
              Threat Legion only scans <strong>public repositories</strong>. Your API key is sent
              directly to your chosen AI provider — it is never stored in plaintext and is never
              shared with third parties. Only public repos are permitted, so your private source
              code is never exposed.
            </p>
          </div>
        </div>
      </main>
